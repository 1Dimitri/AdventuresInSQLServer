...
case 
 when drs.is_primary_replica = 1 and ag_conn.use_ag_listener = 1 then 1
 when drs.is_primary_replica IS NULL and ag_conn.use_ag_listener = 0 then 1
 else 0
end as is_connected_properly,
